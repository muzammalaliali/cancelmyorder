            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="home.php">
                        ...
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text" style="margin: 0 auto; padding: none;">
                            <!-- dark Logo text -->
                            <center><font color='white' size='6rem'><?php echo SiteName; ?></font></center>
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                                    ...
                                    <tbody>
                                        <?php
                                            if(isset($_POST['search'])) {
                                                //$stmt = $database->prepare("SELECT * FROM users WHERE '%{$_POST['search']}%' IN (steam_id, discord_id, user_ip)");
                                    
                                                $stmt = $database->prepare("SELECT * FROM users WHERE `steam_id` LIKE '%{$_POST['search']}%' OR `discord_id` LIKE '%{$_POST['search']}%' OR `steam_name` LIKE '%{$_POST['search']}%' OR `discord_name` LIKE '%{$_POST['search']}%'");
